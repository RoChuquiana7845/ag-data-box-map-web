...
import { MapIcon, LogIn, UserPlus, LayoutDashboard, UserCircle, LogOut } from "lucide-react"
    ...
    >
      <div className="container mx-auto  flex h-16 items-center justify-between">
        <Link href="/" className="flex items-center space-x-2 transition-colors hover:text-primary">
          ...
          <TypewriterEffect text="AgroData Mapper" className="font-bold" speed={0.08} />
        </Link>
          ...
          {isAuthenticated ? (
            <>
              <motion.div variants={itemVariants}>
                <Link href="/dashboard">
                  <motion.div whileHover="hover" initial="initial" variants={buttonHoverVariants}>
                    <Button variant={pathname === "/dashboard" ? "secondary" : "ghost"} className="space-x-2">
              ...
              <motion.div variants={itemVariants}>
                <Link href="/profile">
                  <motion.div whileHover="hover" initial="initial" variants={buttonHoverVariants}>
                    <Button variant={pathname === "/profile" ? "secondary" : "ghost"} className="space-x-2">
              ...
              <motion.div variants={itemVariants}>
                <motion.div whileHover="hover" initial="initial" variants={buttonHoverVariants}>
                  <Button onClick={() => logout()} variant="ghost" className="space-x-2">
